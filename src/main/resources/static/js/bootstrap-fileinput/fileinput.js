...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tVideo = '<video class="kv-preview-data file-preview-video" width="{width}" ' +
                'height="{height}" src="{data}" controls>\n' + $h.DEFAULT_PREVIEW +
                '\n</video>\n';
            ...
            self.defaults = {
                ...
                previewSettings: {
                    ...
                    video: {width: "100%", height: "100%", 'max-width': "90%"},
        ...
        _uploadSingle: function (i, files, allFiles) {
            ...
            fnSuccess = function (data, textStatus, jqXHR) {
                ...
                $.extend(true, params, outData);
                //修改ajax上传返回错误判断,改于2017-6-24 加班 好命苦 -nyvi
                setTimeout(function () {
                    if (data.code == "1") {
                        if (self.showPreview) {
                    	...
                    	self._showUploadError(data.msg, params);
    ...
    $.fn.fileinput = function (option) {
        ...
        this.each(function () {
            ...
            if (!data) {
                ...
                opt = $.extend({}, $.fn.fileinput.defaults, t, $.fn.fileinputLocales.zh, l, options, self.data());
    ...
    $.fn.fileinput.defaults = {
        ...
        allowedFileExtensions: ["gif", "png", "jpg", "jpeg", "bmp", "webp"],
