...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
    	index: 0,	//表格索引,一个页面多个表格时设置,区分icheck
        ...
        ajax: undefined,
        cache: true,
        contentType:'application/x-www-form-urlencoded; charset=UTF-8',//get请求头：'application/json',
        dataType: 'json',
        ajaxOptions: {},
        ...
        strictSearch: false,
        searchAlign: 'right',
        selectItemName: 'checkedid',
        showHeader: true,
        showFooter: false,
        showColumns: false, //显示列修改
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        var index = this.options.index; //同页面表格索引 默认0
            ...
            $.each(columns, function (j, column) {
                ...
                if (column.checkbox) {
                    if (!that.options.singleSelect && that.options.checkboxHeader) {
                        text = sprintf('<input id="btSelectAll_%s" class="icheck" name="btSelectAll" type="checkbox" /><label for="btSelectAll_%s"></label> ', index, index);	
                    }
        ...
        $.each(this.header.fields, function(j, field) {
            ...
            if (column.checkbox || column.radio) {
                ...
                text = [sprintf(that.options.cardView ?
                    ...
                    '<input' +
                    sprintf(' data-index="%s"', i) +
                    sprintf(' id="icheck_%s_%s" class="icheck" ',index, i) +
                    ...
                    ' />'+
                    sprintf(' <label for="icheck_%s_%s"></label>',index, i),
